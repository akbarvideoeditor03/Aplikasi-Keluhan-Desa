            ...
            <div id="menu" class="menu">
                <div class="form">
                    ...
                    <form id="daftarForm">
                      ...
                      <input type="text" name="provinsi" id="provinsi" placeholder="Provinsi*" required value="${savedFormData.provinsi || ''}">
                      <input type="email" name="email" id="email" placeholder="Email*" required value="${savedFormData.email || ''}">
                      <input type="password" name="password" id="password" placeholder="Password*" required>
                      
                      <div class="role-container">
                        <input type="checkbox" name="role" id="role-verifikasi" ${savedFormData.role === 'kepala desa' && savedFormData.verifikasi === false ? 'checked' : ''}>
                        <label for="role-verifikasi">Apakah anda seorang kepala desa?</label>
                      </div>
                      ...
                      <div class="button-group reg-button">
                        <button class="button button-remove" id="cancel">BATAL</button>
                        <button class="button button-accept" id="submit" type="submit">DAFTAR</button>
                      </div>
                    </form>
