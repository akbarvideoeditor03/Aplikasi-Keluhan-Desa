...
const EditAkun = {
    async render() {
        ...
        <div class="container col-container content">
            <h3>Edit Akun</h3>
            <div id="edit" class="card container col-container card-container">
            </div>
        </div>
    `;
    },
    ...
    async afterRender() {
        ...
        const errorNetwork = document.querySelector('#edit'); 
        ...
        if (error) {
            ...
            errorNetwork.classList.add('center', 'card-container');
            errorNetwork.innerHTML = `<p><i class="bi bi-emoji-tear-fill"></i> Sepertinya koneksi internet Anda bermasalah</p>`;
            return;
        }
